...
public class SeataXidFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		System.out.println("seata-springcloud-order ---SeataXidFilter xid:"+xid+",restXid:"+restXid);
		boolean bind = false;
		...
		try {
			...
			if (bind) {
				...
				System.out.println("seata-springcloud-order ---SeataXidFilter unbindXid:"+unbindXid);
				if (logger.isDebugEnabled()) {
